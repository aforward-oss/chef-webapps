# Overview #
Chef cookbook for the webapps, a functional language built on top of erlang.
...
```
cd YOUR_REPO_ROOT
git submodule add https://github.com/aforward/chef-webapps.git chef/cookbooks/webapps
```
